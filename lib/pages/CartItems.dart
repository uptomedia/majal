      ...
      children: [
         Container(
                  ...
                  child: GestureDetector(
                      ...
                      child:
                          RotatedBox(
                            quarterTurns: 2,
                            child:
                      SvgPicture.asset(Assets.SVGArrow,width: 26.w,
          ...
          SizedBox(
            width: 110.w ,),
               // SizedBox(width: 16.w,),
             Center(child: Text("Review order",
        ...
        itemCount:  Provider.of<CartManager>(context, listen: false).distrubersList.length,
        itemBuilder: (context, index) {
          Disturber tmp=Provider.of<CartManager>(context, listen: false).distrubersList[index];
          return
...
height: 18.h,
    ...
    builder: (context, cart, child) =>
                Text(S.of(context).currencyLogo+" "
                     +
                    Provider.of<CartManager>(context, listen: false).totalFiltered.toString() +
...
SizedBox(height: 7.h,),
      Container(
       ...
       Row(children: [
        ...
        Container(
          ...
          child:Center(child:
          Text(
            Provider.of<UserManager>(context, listen: false).wcUserInfo!['username'],
          style: Styles.boldTextStyle.copyWith(
            ...
            fontWeight: FontWeight.w500
                ...
                Center(child:  InkWell(
                     ...
                     Provider.of<UserManager>(context, listen: false).wcUserInfo!['id'] == null) {
                       Utils.pushNewScreenWithRouteSettings(context,
                         settings:
                         RouteSettings(name: RoutePaths.AccountRoot),
                         withNavBar: false,
                         screen:  AccountRoot(
                       ...
                       Utils.pushNewScreenWithRouteSettings(context,
                           settings:
                           RouteSettings(name: RoutePaths.ConfirmationPage),
                           withNavBar: false,
  ...
  _buildCouponWidget() {
    return Container(
      ...
      Provider.of<CartManager>(context, listen: false).cartState==cartStates.pending?CircularProgressIndicator(color: Styles.colorPrimary,):
      Column(
        children: [
          TextField(
...
keyboardType:TextInputType.text ,
            onSubmitted: (value) {
              Provider.of<CartManager>(context, listen: false)
                  .applyCoupon(_couponController!.text.toString() ?? "");
...
style: Styles.regularTextStyle.copyWith(fontSize:Styles.fontSize18,color: Styles.colorPrimary),
            decoration:  InputDecoration(
              ...
              hintStyle: Styles.regularTextStyle.copyWith(fontSize:Styles.fontSize18,color: Styles.colorPrimary),
              border: Styles.roundedOutlineInputBorder(radius: 25.r,),
              focusedBorder:Styles.roundedOutlineInputBorder(radius: 25.r),
              enabledBorder: Styles.roundedOutlineInputBorder(radius: 25.r),
              errorBorder: Styles.roundedOutlineInputBorder(radius: 25.r)
                  .copyWith(borderSide: BorderSide(color: Colors.red)),
              focusedErrorBorder: Styles.roundedOutlineInputBorder(radius: 25.r)
                  .copyWith(borderSide: BorderSide(color: Colors.red)),
              disabledBorder: Styles.roundedOutlineInputBorder(radius: 25.r),
              ...
              suffixIcon: GestureDetector(
                  ...
                  onTap: () {
                    setState(() {
                      Provider.of<CartManager>(context, listen: false)
                          .applyCoupon(_couponController!.text.toString() ?? "").then((value) => setState((){
          ...
          //       labelText: S.of(context).coupon,
          //       hintText: S.of(context).coupon,
          //       prefixIcon: Icon(Icons.code, color: Styles.colorprimary[700]),
          //     )),
          // RaisedButton(
          //   onPressed: () {
          //
          //   },
          //   child: Text(S.of(context).apply, style: TextStyle(color: Colors.white)),
          // ),
        ],
      ),
    );
