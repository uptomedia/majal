...
key: _scaffoldKey,
      ...
      mainAxisSize: MainAxisSize.min,
        ...
        Container(
          ...
          TextField(
            ...
            decoration: Styles.LoginFieldDecoration(radius: 18.r,
            hint: S.of(context).email,
                color: Styles.ColorWhite          // prefixIcon: title == S.of(context).username
        ...
        Container(
          ...
          TextField(
            ...
            onSubmitted: (value){
              ...
              decoration: Styles.LoginFieldDecoration(radius: 23.r,
          ...
          Row(
            ...
            children: <Widget>[
              Text(S.of(context).shippingAddress, style: this._headerTextStyle),
              IconButton(
    ...
    child:
          Row(
            ...
            children: <Widget>[
              ...
              Text(S.of(context).billingAddress, style: this._headerTextStyle),
              IconButton(
                icon: Icon(Icons.edit, color: Styles.colorPrimary),
                onPressed: () =>
    ...
    child:
    Center(child: Text(S.of(context).placeOrder,
                    style: Styles.boldTextStyle.copyWith(
                ...
                onTap: () {
                  ...
                  Utils.pushNewScreenWithRouteSettings(context,
                    ...
                    screen: OrderPlacementPage(
                      ...
                      items: Provider.of<CartManager>(context,listen: false).filterCartItems,
                    ),
