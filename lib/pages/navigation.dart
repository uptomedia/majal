        ...
        body: PersistentTabView.custom(
          ...
          onWillPop: (context) async {
            ...
            if (backButtonHasNotBeenPressedOrSnackBarHasBeenClosed) {
              ...
              Fluttertoast.showToast( msg: S.of(context!).pressTwiceToExit,
                  textColor:Styles.ColorWhite,backgroundColor:Styles.colorPrimary.withOpacity(1));
              return false;
            } else {
              SystemNavigator.pop();
  ...
  List<PersistentBottomNavBarItem> _navBarsItems() {
    return [
      PersistentBottomNavBarItem(
        icon: SvgPicture.asset(Assets.SVG_homeActive,width: 26.w,),

        title: S.of(context).home,
        inactiveIcon:SvgPicture.asset(Assets.SVG_homeinActive,width: 26.w,),
        activeColorPrimary: Styles.secondaryColor,
        inactiveColorPrimary: CupertinoColors.systemGrey,
      ),
      PersistentBottomNavBarItem(
        icon:SvgPicture.asset(Assets.SVG_disturbersActive,width: 26.w,),
        inactiveIcon:SvgPicture.asset(Assets.SVG_disturbersInActive,width: 26.w,),
      ...
      PersistentBottomNavBarItem(
         icon:SvgPicture.asset(Assets.SVG_orderActive,width: 26.w,),
        inactiveIcon:SvgPicture.asset(Assets.SVG_orderinActive,width: 26.w,),
        title: S.of(context).orders,
          activeColorPrimary: Styles.secondaryColor,
        inactiveColorPrimary: CupertinoColors.systemGrey,
      ),  PersistentBottomNavBarItem(
        icon:SvgPicture.asset(Assets.SVG_profileActive,width: 26.w,),
        inactiveIcon:SvgPicture.asset(Assets.SVG_profileinActive,width: 26.w,),
