...
class _AddressDetailsState extends State<AddressDetails> {
  ...
  Widget build(BuildContext context) {
    return Consumer<UserManager>(
      builder: (context, user, child) {
        ...
        if (addressShip == null || addressShip.length == 0) {
          addressShip.addAll(user.wcUserInfo!["shipping"]);
        }
        // print(address);
        if (address == null || address.length == 0) {
          return Scaffold(
                      ...
                      Container(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                              ...
                              child: address.keys.elementAt(index) ==
                                          'postcode' &&
                                      ...
                                      ? Expanded(
                                          ...
                                          child:
                                            ...
                                            items: <DropdownMenuItem<String>>[
                                              ..._getMenuCountryItems(
                                                  _controller.text)
                                            ],
                                            onChanged: (value) =>
                                                _controller.text = value!,
                                            decoration:
                                                Styles.PharmaFieldDecoration(
                                                    radius: 23.r,
                                                    hint: _formatName(address
                                                        .keys
                                                        .elementAt(index))),
                      ...
                      if (_withshipping)
                        Container(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            this._textControllersShipping[key] =
                                _controllerShipping;
                            ...
                            return Container(
                                ...
                                // padding: EdgeInsets.symmetric(vertical: 0, horizontal:37.w),
                                child: addressShip.keys.elementAt(index) ==
                                        'postcode'
                                    ? TextField(
                            ...
                            child: Center(
                              ...
                              children: [
                                ...
                                Text(
                                  !_withshipping
                                      ? S.of(context).addAnotherBillingAddress
                                      : S.of(context).removeThisBillingAddress,
                                  style: Styles.regularTextStyle.copyWith(
                                      fontSize: Styles.fontSize18,
                                      color: _withshipping
                                          ? Styles.colorDeleteBackground
                                          : Styles.colorPrimary),
                                )
                              ],
                            ))),
    ...
    //       address = user.wcUserInfo![widget.type];
    //     if (addressShip == null || addressShip.length == 0) {
    //       address.addAll(user.wcUserInfo!["shipping"]);
    //     }
    //     // print(address);
    //     if (address == null || address.length == 0) {
    //       return Scaffold(
